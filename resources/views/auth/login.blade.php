<div class="container">
    <div class="login-wrapper">
        <h4 class="w-100 text-center mt-5">{{__('cpscn Routine Management')}}</h4>
        <h4 class="w-100 text-center mt-4">{{__('Admin Login')}}</h4>
        <div class="login-body m-auto">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group row w-100 m-auto mt-1">
                ...
                <div class="form-group row mb-0">
                    <div class="ml-3">
                        <button type="submit" class="action-button loginBtn">
                            {{ __('Login') }}
                        </button>
