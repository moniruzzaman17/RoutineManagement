 ...
 */
 ...
 function base_url() {
 	...
 	if (location.host == 'localhost') {
        var url = location.origin + '/' + pathparts[1].trim('/'); // http://localhost/Shuddho/
    } else {
        var url = location.origin; // http://maindomain.com
    }
    return url;
}
...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath: 'https://shuddhoraj.com.bd/img/nicEditorIcons.gif',
